...
2. **Two analyses that need more than one statement:** a **single-assignment-per-
   ...
   group/enum names against the m1-example `CONTRIBUTING.md` naming conventions.
...
Convention predicates (from m1-example `CONTRIBUTING.md` §"Naming Conventions"):
